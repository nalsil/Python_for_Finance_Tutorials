...
def patternStorage():
    ...
    print('Pattern count=', len(patternAr), len(performanceAr))
...
def currentPattern():
    ...
    print('currentPattern=', patForRec)
...
def patternRecognition():
    ...
    print('@@@ Begin patternRecognition @@@')
    ...
    if patFound == 1:
        ...
        #################
        print(predArray)
        preditionAverage = reduce(lambda x, y: x+y, predArray) / len(predArray)
        print(preditionAverage)

        if preditionAverage < 0:
